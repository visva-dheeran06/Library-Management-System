...
public class Reports {
    ...
    public static String formatWaitingList(List<String> memberIds, Map<String, Member> members) {
        ...
        for (String mid : memberIds) {
            ...
            sb.append(position++).append(". ").append(m.name)
              .append(" (").append(m.membershipType).append(")\n");
        }
        return sb.toString();
    }
    ...
    public static String formatLeaderboard(List<Book> topBooks) {
        ...
        int rank = 1;
        for (Book b : topBooks) {
            sb.append(rank++).append(". ").append(b.title)
              .append(" by ").append(b.author)
              .append(" - borrowed ").append(b.timesBorrowed).append(" times\n");
        }
        return sb.toString();
    }
